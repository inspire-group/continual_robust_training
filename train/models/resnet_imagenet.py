...
model_urls = {
    ...
    'resnet101': 'XXXX',
    'resnet152': 'XXXX',
    'resnext50_32x4d': 'XXXX',
    'resnext101_32x8d': 'XXXX',
    'wide_resnet50_2': 'XXXX',
    'wide_resnet101_2': 'XXXX',
}
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, freeze: bool, contrast=False, use_self_features=False) -> Tensor:
    ...
    def forward(self, x, freeze=False, contrast=False, use_self_features=False) -> Tensor:
        return self._forward_impl(x, freeze, contrast=contrast, use_self_features=use_self_features)
